...
I intend to analyse the trigram or fourgram to predict the next word that the user will write. I will start to study the models that I can use to make these analysis and the computational requirements of them.
